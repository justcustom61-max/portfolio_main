...
return ( <section
 ...
 > <div className="max-w-3xl mx-auto w-full"> <h2 className="text-4xl md:text-6xl font-display font-bold text-center mb-4 gradient-text">
Let's Build Something Amazing </h2>
